                ...
                .setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        String w_amount = workeramount.getText().toString();
                         Toast.makeText(getContext(), "" + w_role + w_name + w_number + w_mail + w_address + w_place +w_category+ w_pcode + w_amount + w_staus, Toast.LENGTH_SHORT).show();
                        ...
                        WorkersPojoModel workersPojoModel =
                                new WorkersPojoModel(w_role, w_name, w_number,w_mail, w_address, w_place,w_pcode, w_category,w_staus,w_amount);
                        //workerslist.add(workersPojoModel);

                        reference.child("WorkersDatabase").child(w_category).push().setValue(workersPojoModel).addOnSuccessListener(new OnSuccessListener<Void>() {
                            @Override
