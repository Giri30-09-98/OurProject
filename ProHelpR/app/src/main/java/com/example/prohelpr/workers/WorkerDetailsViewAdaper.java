...
public class WorkerDetailsViewAdaper extends RecyclerView.Adapter<WorkerDetailsViewAdaper.WorkerDetailsViewHolder> {
    ...
    public void onBindViewHolder(@NonNull WorkerDetailsViewHolder holder, int position) {
        ...
        holder.obj_tv_workerRole.setText(models.get(position).getW_role());
        holder.obj_tv_workerName.setText(models.get(position).getW_name());
        holder.obj_tv_workerNumber.setText(models.get(position).getW_number());
        holder.obj_tv_workerMail.setText(models.get(position).getW_mail());
        holder.obj_tv_workeraddress.setText(models.get(position).getW_address());
        holder.obj_tv_worker_place.setText(models.get(position).getW_place());
        holder.obj_tv_workerChatogory.setText(models.get(position).getW_category());
